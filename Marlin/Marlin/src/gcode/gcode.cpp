...
void GcodeSuite::get_destination_from_command() {
  ...
  if ( (seen.e = parser.seenval('E')) ) {
    ...
    if (PrintJobRecovery::enabled && IS_SD_PRINTING() && seen.e && (seen.x || seen.y))
  ...
  */
  ...
  switch (parser.command_letter) {
    ...
    case 'M': switch (parser.codenum) {
      ...
      case 2100:printTotalTime = parser.ulongval('T',0);break;
      case 2101:modifyTotalTime = parser.ulongval('T',0);break;
      case 8885:
        {
          PrintJobRecovery::info.sd_longname[0] = 'n';
          PrintJobRecovery::info.sd_longname[1] = 'o';
          PrintJobRecovery::info.sd_longname[2] = 0;
          screenPopIndex(parser.intval('I'));
        }
        break;
      case 8886:
        {
...
void GcodeSuite::process_next_command() {
  ...
  #if ENABLED(POWER_LOSS_RECOVERY)
    PrintJobRecovery::queue_index_r = queue.index_r;
  #endif

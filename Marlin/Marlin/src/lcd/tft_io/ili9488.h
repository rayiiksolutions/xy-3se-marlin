...
static const uint16_t ili9488_init[] = {
  ...
  /* Gamma Correction. */
  ESC_REG(ILI9488_PGAMCTRL), 0x0000, 0x0003, 0x000C, 0x0009, 0x0017, 0x0009, 0x003E, 0x0089, 0x0049, 0x0008, 0x000D, 0x000A, 0x0013, 0x0015, 0x000F,
  ESC_REG(ILI9488_NGAMCTRL), 0x0000, 0x0011, 0x0015, 0x0003, 0x000F, 0x0005, 0x002D, 0x000B, 0x000A, 0x0033, 0x0037, 0x000F,
  ESC_REG(0xB1),0x00B0,0x0000,//frame rate
